        ...
        children: [
            ...
            children: [
                ...
                children: [
                  Row(
                    children: [
                     ...
                     userName == null ? Center(child: CircularProgressIndicator(color: MyColor().primaryClr,),) : Text(
                        "$userName!",
                        style: GoogleFonts.poppins(
                          fontSize: 14,
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Badge.count(count: 10,child: Icon(Icons.notifications, size: 18)),
                ),
              ),
            ],
          ),
          ...
          Center(
            child: Container(
              ...
              child: TextFormField(
                onTap: (){
                  Navigator.push(context, MaterialPageRoute(builder: (_)=> BottomNavigationBarPage(pageIndex: 1, whichScreen: '',)));
                },
