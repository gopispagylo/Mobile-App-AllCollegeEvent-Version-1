  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView(
        children: [
          SizedBox(height: 20,),
          Text(textAlign: TextAlign.center,"Choose Your Location to Discover Events",style: GoogleFonts.poppins(
          ...
          Center(
            child: Container(
              ...
              child: Text("Popular Cities",style: GoogleFonts.poppins(
          ...
          Container(
            ...
            child: GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,mainAxisSpacing: 16,crossAxisSpacing: 16,childAspectRatio: 1,)),
          ),
          ...
          Center(
            child: Container(
              ...
              child: Text("Popular Countries",style: GoogleFonts.poppins(
                  fontWeight: FontWeight.w600,fontSize: 18,color: MyColor().primaryClr
              ),),
            ),
          ),
