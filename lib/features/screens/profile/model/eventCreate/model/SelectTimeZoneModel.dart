...
class _SelectTimeZoneModelState extends State<SelectTimeZoneModel> {
  // ------- time zone --------
  final List<String> timeZoneList = ['India', 'USA'];
  ...
  final List<DateTimeBlock> dateTimeBlock = [DateTimeBlock()];
            ...
            child: Container(
              ...
              child: MyModels().customDropdown(
                ...
                items: timeZoneList
                    ...
                    .toList(),
                valid: Validators().validTimeZone,
              ),
            ),
          ),
            ...
            children: [
              ...
              Center(
                child: Column(
                  ...
                  children: [
                    // ------ google meet link ---------
                    if (selectEventMode == 'ONLINE' ||
                        selectEventMode == 'HYBRID')
                      Container(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  validator: Validators().validGoogleMeet,
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        "Enter the access link for your online event.",
                    ...
                    // ------ Country dropdown --------
                    if (selectEventMode == 'HYBRID' ||
                        selectEventMode == 'OFFLINE')
                    ...
                    if (selectEventMode == 'HYBRID' ||
                      ...
                      Container(
                        ...
                        child: MyModels().customTextField(
                          ...
                          validator: Validators().validVenue,
                            ...
                            MaterialPageRoute(
                              builder: (_) => MediaAndTicketsPage(
                                orgDetailList: {
                                  ...
                                  if (selectEventMode == "ONLINE" ||
                                      selectEventMode == "HYBRID")
                                    'eventLink': googleMeetController.text,
                                  if (selectEventMode == 'HYBRID' ||
                                      selectEventMode == "OFFLINE")
                                    'location': {
                                      ...
                                      "state": selectedState,
                                      "city": selectedCity,
                                      "mapLink": googleMapController.text,
