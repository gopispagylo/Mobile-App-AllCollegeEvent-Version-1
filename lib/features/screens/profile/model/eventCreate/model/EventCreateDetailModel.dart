    ...
    return Form(
      ...
      child: ListView(
        children: [
          ...
          // ----- Event Title ------
          MyModels().customTextFieldWithLimit(
            label: "Event Title *",
            ...
            limit: 50,
            validator: Validators().validTitle,
            readOnly: false,
          ),
          ...
          Center(
            child: Container(
              margin: EdgeInsets.only(
                left: 16,
                right: 16,
                bottom: selectAceCategories != null ? 20 : 0,
              ),
                      ...
                      child: MyModels().customDropdown(
                        ...
                        onChanged: (category) {
                          ...
                          context.read<EventTypeBloc>().add(
                            ClickedEventType(identity: selectAceCategories!),
                          );
                        },
                        items: aceCategoriesState.aceCategoriesList
                            .map(
                  ...
                  if (eventTypeState is EventTypeLoading) {
                    ...
                    return SizedBox(
                      ...
                      child: MyModels().customDropdown(
                        ...
                        items: eventTypeState.eventTypeList
                            .map(
                              (e) => DropdownMenuItem<String>(
                                value: e['identity'],
                                child: Text(e['name']),
                        ...
                        child: GestureDetector(
                          onTap: () {
                            if (searchableKeywordsController.text.isNotEmpty) {
                              context.read<SearchableKeyBloc>().add(
                                ClickSearchableKey(
                                  searchableText:
                                      searchableKeywordsController.text,
                                ),
                              );
                              searchableKeywordsController.clear();
                            } else {
                              FlutterToast().flutterToast(
                                "At least add one searchable keywords",
                ...
                if (state is AddSuccess) {
                  return Container(
                    ...
                    child: Wrap(
                      runSpacing: 5,
                      spacing: 5,
                      children: List.generate(state.searchableKeyList.length, (
                        index,
                      ) {
                        return Expanded(
                          child: Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      context.read<SearchableKeyBloc>().add(
                                        RemoveClickSearchableKey(index: index),
                                      );
                                    },
                                    child: Icon(
          ...
          Container(
            ...
            child: MyModels().customTextFieldWithLimitWithoutValid(
              label: "Offers",
          ...
          Center(
            child: Container(
              ...
              child: MyModels().textFormFieldCommentLimited(
                ...
                valid: "Please enter about the event",
