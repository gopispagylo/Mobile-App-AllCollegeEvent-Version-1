...
class EventDetailModel extends StatefulWidget {
  ...
  const EventDetailModel({
    ...
    required this.title,
    required this.whichScreen, required this.paymentLink,
  });
          ...
          if (eventDetailState is EventDetailLoading) {
            ...
            return ListView(
              children: [
                ...
                // --------- Carousel Slider ------
                if(list['bannerImages'] != null && list['bannerImages'].isNotEmpty) CarouselSlider.builder(
                ...
                if(list['bannerImages'] != null && list['bannerImages'].isNotEmpty) Container(
               ...
               if(checkEdit) Align(
                ...
                if(checkEdit) Align(
                  ...
                  child: GestureDetector(
                    onTap: (){
                      MyModels().alertDialogContentCustom(context: context, content: Form(
                        key: formKey,
                        child: ListView(
                          shrinkWrap: true,
                          children: [
                            Text("This Field Is Locked",style: GoogleFonts.poppins(
                              fontWeight: FontWeight.w500,fontSize: 20,color: MyColor().primaryClr
                            ),),
                            Container(
                              margin: EdgeInsets.only(top: 15),
                              child: Text(textAlign: TextAlign.center,"This information cannot be edited directly.",style: GoogleFonts.poppins(
                                fontWeight: FontWeight.w400,fontSize: 14,color: MyColor().blackClr
                              ),),
                            ),
                            Text(textAlign: TextAlign.center,"If you need to make changes, please contact the admin for assistance.",style: GoogleFonts.poppins(
                              fontWeight: FontWeight.w400,fontSize: 14,color: MyColor().blackClr
                            ),),
                            Container(
                                  ...
                                  child: Column(
                                    children: [
                                      Container(
                                        ...
                                        child: Text("Describe Your Request",style: GoogleFonts.poppins(
                                            fontSize: 14,
                                            fontWeight: FontWeight.w600
                                        ),),
                                      ),
                                      SizedBox(
                                        ...
                                        child: TextFormField(
                                          ...
                                          validator: Validators().validContactAdmin,
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintText: "Enter describe your request",
               ...
               selectedIndex == 0 ? Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.center,
                        children: [
                          if(list['videoLink'] != null) GestureDetector(
                           onTap: () async{
                             final url = Uri.parse(list['videoLink']);
                          ...
                          if(list['eventLink'] != null) GestureDetector(
                           onTap: () async{
                             final url = Uri.parse(list['eventLink']);
                             await launchUrl(url,mode: LaunchMode.externalApplication);
                           },
                           child: Container(
                             margin: EdgeInsets.only(right: 10),
                          ...
                          if(list['location']['mapLink'] != null) GestureDetector(
                            onTap: () async{
      
                              final url = Uri.parse(list['location']['mapLink']);
                              await launchUrl(url,mode: LaunchMode.externalApplication);
                          ...
                          children: [
                            ...
                            GridView.builder(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                final ticketStartDate = DateTime.parse(ticket['sellingFrom']);
                                final ticketEndDate = DateTime.parse(ticket['sellingTo']);
                                ...
                                } else if (now.isAfter(ticketEndDate)) {
                                  checkTicketStatus = "Ticket Expired";
                                } else {
                                  checkTicketStatus = "Ticket is live";
                                }
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        decoration: BoxDecoration(
                                            borderRadius: BorderRadius.circular(30),
                                            color: checkTicketStatus == "Yet to start" ?  MyColor().yellowClr.withOpacity(0.10) : checkTicketStatus == "Ticket Expired" ? MyColor().redClr.withOpacity(0.15) : MyColor().greenClr.withOpacity(0.15)
                                        ),
                                        margin: EdgeInsets.only(top: 10),
                                        child: Text(checkTicketStatus,style: GoogleFonts.poppins(
                                            fontWeight: FontWeight.w600,fontSize: 11,color: checkTicketStatus == "Yet to start" ?  MyColor().blackClr : checkTicketStatus == "Ticket Expired" ? MyColor().redClr : MyColor().greenClr
                                        ),),
                                      ),
                                      ...
                                      Row(
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Icon(Iconsax.tag,size: 10,color: MyColor().primaryClr,),
                                          ),
                                      ...
                                      bulletText(ticket['price'] != 0 ? ticket['price'].toString() : 'Free Cost', Iconsax.tag),
                                      bulletText(checkTicketStatus == "Yet to start" ? "Ticket start at ${DateFormat('dd/MM').format(DateTime.parse(ticket['sellingTo']))}" : "Ticket ends at ${DateFormat('dd/MM').format(DateTime.parse(ticket['sellingFrom']))}", Iconsax.calendar),
                                    ],
                                  ),
                                );
                              },
                    ...
                    if(checkEdit) Align(
                      ...
                      child: Container(
                        ...
                        margin: EdgeInsets.only(right: 16,bottom: 10,top: 0),
                        alignment: Alignment.center,
                        child: Text('Edit',style: GoogleFonts.poppins(
                            fontSize: 14,color: MyColor().whiteClr,fontWeight: FontWeight.w500
                        ),),
                 ...
                 children: [
                               ...
                               Expanded(
                                 child: _infoCard(
                                   ...
                                   items: [
                                     ...
                                     if(list['Collaborator'][index]['member']['orgDept'] != null && list['Collaborator'][index]['member']['orgDept'].isNotEmpty) _infoRow(Iconsax.book, list['Collaborator'][index]['member']['orgDept']),
                                   ],
                                 ),
                               ),
                             ],
                   ...
                   // ------- Follow us on ------
                   if(list['socialLinks']['linkedin'] != null && list['socialLinks']['linkedin'].isNotEmpty && list['socialLinks']['instagram'] != null && list['socialLinks']['instagram'].isNotEmpty && list['socialLinks']['whatsapp'] != null && list['socialLinks']['whatsapp'].isNotEmpty)Container(
                     margin: EdgeInsets.only(
                       left: 16,
                       right: 16,
                       // top: 10,
                             ...
                             child: Row(
                               ...
                               children: [
                                 ...
                                 Row(
                                   ...
                                   if(list['socialLinks']['whatsapp'] != null && list['socialLinks']['whatsapp'].isNotEmpty)  GestureDetector(
                                       onTap: () async{
                                         final whatsApp = Uri.parse(list['socialLinks']['whatsapp']);
                                         await launchUrl(whatsApp,mode: LaunchMode.externalApplication);
                                       },
                                       child: Container(
                                           padding: EdgeInsets.all(5),
                                           child: Image.asset(ImagePath().whatsapp,height: 40,)),
                                     ),
      
                                    if(list['socialLinks']['instagram'] != null && list['socialLinks']['instagram'].isNotEmpty) GestureDetector(
                                       onTap: () async{
                                         final whatsApp = Uri.parse(list['socialLinks']['instagram']);
                                         await launchUrl(whatsApp,mode: LaunchMode.externalApplication);
                                       },
                                       child: Container(
                                           padding: EdgeInsets.all(5),
                                           child: Image.asset(ImagePath().instagram,height: 37,)),
                                     ),
      
                                    if(list['socialLinks']['linkedin'] != null && list['socialLinks']['linkedin'].isNotEmpty) GestureDetector(
                                       onTap: () async{
                                         final whatsApp = Uri.parse(list['socialLinks']['linkedin']);
                                         await launchUrl(whatsApp,mode: LaunchMode.externalApplication);
                                       },
                                       child: Container(
                                           padding: EdgeInsets.all(5),
                                           child: Image.asset(ImagePath().linkedIn,height: 35,)),
                                     ),
                          ...
                          SizedBox(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                enabledBorder: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(12),
                                    borderSide: BorderSide(color: MyColor().whiteClr,width: 0.5)
                                ),
                                focusedBorder: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(12),
                                    borderSide: BorderSide(color: MyColor().whiteClr,width: 0.5)
              ...
              Expanded(
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: checkPaymentLink ? Center(child: CircularProgressIndicator(color: MyColor().whiteClr,),) : Text(
                      "Register",
                      style: GoogleFonts.poppins(
                        fontSize: 14,
                        color: MyColor().whiteClr,
