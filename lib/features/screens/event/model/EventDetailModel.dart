          ...
          return BlocBuilder<EventDetailBloc, EventDetailState>(
            builder: (context, eventDetailState) {
              if (eventDetailState is EventDetailLoading) {
                ...
                final checkPaid = list['tickets'].isNotEmpty
                    ? list['tickets'][0]['isPaid']
                    : true;
                        ...
                        Container(
                          ...
                          child: CarouselSlider.builder(
                            ...
                            options: CarouselOptions(
                              ...
                              autoPlay: currentPage == 0 ? false : true,
                          ...
                          ? Column(
                              ...
                              children: [
                                ...
                                if (list['eventPerks'].isNotEmpty ||
                                    list['cert'] != null ||
                                    list['eventAccommodations'].isNotEmpty ||
                                    list['tags'].isNotEmpty)
                                  Container(
                                    margin: EdgeInsets.only(
                                      left: 16,
                                      right: 16,
