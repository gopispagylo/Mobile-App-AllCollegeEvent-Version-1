...
class _EventDetailModelState extends State<EventDetailModel> with WidgetsBindingObserver{
  ...
  listener: (context, eventCountState) {
    if(eventCountState is EventCountUpdateFail){
      FlutterToast().flutterToast(eventCountState.errorMessage, ToastificationType.error, ToastificationStyle.flat);
    }
  },
  builder: (context, eventCountState) {
    return BlocBuilder<EventDetailBloc, EventDetailState>(builder: (context, eventDetailState) {
      if (eventDetailState is EventDetailLoading) {
        ...
        String toTitleCase(String text){
          return text.toLowerCase().split(' ').map((e)=> e.isNotEmpty ? '${e[0].toUpperCase()}${e.substring(1)}' : '').join(' ');
        }

        // ----- format date and time --------
        final dateFormat = DateFormat("dd MMM yy");

        String location = "${toTitleCase(list['location']['venue'] ?? '')}, ${list['location']['city'] ?? ''}";
          ...
          children: [
                    ...
                    children: [
                      BlocConsumer<EventLikeBloc, EventLikeState>(
                        ...
                        builder: (context, eventState) {
                          ...
                          final checkFav = bloc.favStatus[widget.identity.toString()] ?? list['isLiked'];
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Expanded(
                      child: customTabBar(title: 'Host Details', index: 1),
                    ),
                  ],
                ),
              ),
            ...
            selectedIndex == 0
              ...
              children: [
                ...
                // ------- venue ------
                if(list['location']['mapLink'] != null) Container(
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Icon(Iconsax.location_copy,size: 20,),
                              SizedBox(width: 10,),
                              Expanded(
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              Icon(Iconsax.calendar_copy,size: 20,),
                              SizedBox(width: 10,),
                              Text(startAndEndEvent,style: GoogleFonts.poppins(
                                  fontSize: 14,fontWeight: FontWeight.w500,color: MyColor().blackClr
                              )),
                            ],
                          ),
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                Icon(Iconsax.map),
                                SizedBox(width: 10,),
                                Text('View Map Location',style: GoogleFonts.poppins(
                      ...
                      children: [
                        ...
                        GridView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            final ticketStartDate = DateTime.parse(
                              ticket['sellingFrom'],
                            );
                ...
                Container(
                  ...
                  child: Container(
                    margin: EdgeInsets.all(16),
                    child: Wrap(
                      children: List.generate(list['tags'].length, (
                          index,
                          ) {
                        return Container(
