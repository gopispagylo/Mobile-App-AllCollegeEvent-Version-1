...
class _EventListModelState extends State<EventListModel> {
  ...
  final virtualScrollController = ScrollController();
  ...
  void initState() {
    ...
    scrollController.addListener(() {
      if (scrollController.position.pixels >=
        ...
        context.read<UpComingEventBloc>().add(
          FetchUpComingEventList(isLogin: widget.isLogin, loadMore: true),
        );
      }
    });
    ...
    upComingScrollController.addListener(() {
      if (upComingScrollController.position.pixels >=
          upComingScrollController.position.maxScrollExtent - 50) {
        context.read<FeaturedEventBloc>().add(
          FetchFeaturedEventList(isLogin: widget.isLogin, loadMore: true),
        );
      }
    });
    ...
    trendingScrollController.addListener(() {
      if (trendingScrollController.position.pixels >=
          trendingScrollController.position.maxScrollExtent - 50) {
        context.read<TrendingEventListBloc>().add(
          FetchTrendingEventList(isLogin: widget.isLogin, loadMore: true),
        );
      }
    });
    virtualScrollController.addListener(() {
      if (virtualScrollController.position.pixels >=
          virtualScrollController.position.maxScrollExtent - 50) {
        context.read<VirtualEventBloc>().add(
          FetchVirtualEventList(isLogin: widget.isLogin, loadMore: true),
        );
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return RefreshIndicator(
      ...
      onRefresh: () async {
        context.read<UpComingEventBloc>().add(
          FetchUpComingEventList(isLogin: widget.isLogin),
        );
        context.read<TrendingEventListBloc>().add(
          FetchTrendingEventList(isLogin: widget.isLogin),
        );
        context.read<VirtualEventBloc>().add(
          FetchVirtualEventList(isLogin: widget.isLogin),
        );
        context.read<TrendingEventListBloc>().add(
          FetchTrendingEventList(isLogin: widget.isLogin),
        );
        ...
        children: [
          ...
          BlocBuilder<UpComingEventBloc, UpComingEventState>(
            builder: (context, upComingEventState) {
              if (upComingEventState is UpComingEventListLoading) {
                return categoryShimmer();
              } else if (upComingEventState is UpComingEventListSuccess) {
                return Column(
                  children: [
                    Container(
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final list =
                              upComingEventState.upComingEventList[index];
          ...
          // Featured event list
          BlocBuilder<FeaturedEventBloc, FeaturedEventState>(
            builder: (context, featuredEventState) {
              if (featuredEventState is FeaturedEventListLoading) {
                return categoryShimmer();
              } else if (featuredEventState is FeaturedEventListSuccess) {
                return Column(
                  children: [
                    Container(
                      margin: EdgeInsets.only(top: 20, left: 16, right: 6),
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount:
                            featuredEventState.featuredEventList.length +
                            (featuredEventState.hasMore ? 1 : 0),
                        itemBuilder: (context, index) {
                          if (index ==
                              featuredEventState.featuredEventList.length) {
                            return Padding(
                          ...
                          final list =
                              featuredEventState.featuredEventList[index];
          ...
          // Virtual event list
          BlocBuilder<VirtualEventBloc, VirtualEventState>(
            builder: (context, virtualEventState) {
              if (virtualEventState is VirtualEventListLoading) {
                return categoryShimmer();
              } else if (virtualEventState is VirtualEventListSuccess) {
                return Column(
                  children: [
                    Container(
                      margin: EdgeInsets.only(top: 20, left: 16, right: 6),
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount:
                            virtualEventState.virtualEventList.length +
                            (virtualEventState.hasMore ? 1 : 0),
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final list =
                              virtualEventState.virtualEventList[index];
